 ...
 */
final class Version20231127104830 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD CONSTRAINT FK_F804D3B9921B5861 FOREIGN KEY (idLO) REFERENCES lieu (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
